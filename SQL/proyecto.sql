--------------------------------------------------------
-- Archivo creado  - viernes-abril-01-2022   
--------------------------------------------------------
DROP TABLE "PROYECTO"."AUTORES" cascade constraints;
DROP TABLE "PROYECTO"."DATOS_USUARIOS" cascade constraints;
DROP TABLE "PROYECTO"."EDITORIALES" cascade constraints;
DROP TABLE "PROYECTO"."FABRICANTES" cascade constraints;
DROP TABLE "PROYECTO"."MARCAS" cascade constraints;
DROP TABLE "PROYECTO"."PRODUCTO_COMIDA" cascade constraints;
DROP TABLE "PROYECTO"."PRODUCTO_LIBROS" cascade constraints;
DROP TABLE "PROYECTO"."PRODUCTO_ROPA" cascade constraints;
DROP TABLE "PROYECTO"."PRODUCTOS" cascade constraints;
DROP TABLE "PROYECTO"."PRODUCTOS_TIENDA" cascade constraints;
DROP TABLE "PROYECTO"."TIENDAS" cascade constraints;
